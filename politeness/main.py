        ...
        jsondata = json.dumps(
            {
                ...
                "message_6": feedback[6],
                "message_7": feedback[7],
                "message_8": feedback[8],
                "message_9": feedback[9],
                ...
                "feature_name_6": ranked_features[6],
                "feature_name_7": ranked_features[7],
                "feature_name_8": ranked_features[8],
                "feature_name_9": ranked_features[9],
            })
