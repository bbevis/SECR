fancy_responses = {
    ...
    {'fancy_name': 'Agreement phrases',
     'recog': '''<p>Although you may not agree with their viewpoint, highlighting specific areas where you do agree signals that you value their opinions.<br>
     The algorithm noticed you <b>used enough</b> agreement phrases (e.g. <q>I agree</q>, <q>you are right</q>).<br>
     <b>Keep using these phrases</b> next time!</p>''',
     'imp': '''<p>Although you may not agree with their viewpoint, highlighting specific areas where you do agree signals that you value their opinions.<br>
    ...
    {'fancy_name': 'Positive emotion phrases',
     'recog': '''<p>Phrasing your arguments in a positive way makes you appear less threatening. This will induce a more positive response.<br>
     The algorithm noticed you <b>used enough</b> positive emotion words (e.g. <q>good</q>, <q>happy</q>).<br>
     <b>Keep using these words</b> next time!</p>''',
     'imp': '''<p>Phrasing your arguments in a positive way makes you appear less threatening. This will induce a more positive response.<br>
    ...
    {'fancy_name': 'Reasoning words',
     'imp': '''<p>Expressions such as therefore and because can sound argumentative or condescending which may induce a more defensive tone from the other party.<br>
     ...
     'recog': '''<p>Expressions such as therefore and because can sound argumentative or condescending which may induce a more defensive tone from the other party.<br>
    ...
    {'fancy_name': 'Subjective phrases',
     'recog': '''<p>Subjective phrases help to make your arguments seem less direct in opposition. Being less direct signals your intention to engage in a debate rather than to fight.<br>
     The algorithm noticed you <b>used enough</b> subjective phrases (e.g. <q>I believe</q> or <q>In my opinion</q>).<br>
     <b>Keep using these phrases</b> next time!</p>''',
     'imp': '''<p>Subjective phrases help to make your arguments seem less direct in opposition. Being less direct signals your intention to engage in a debate rather than to fight.<br>
    ...
    {'fancy_name': 'Acknowledgement phrases',
     'recog': '''<p>Actively acknowledging that other opinions are valid, even if you do not agree with them, signals that you listen. This in turn encourages others to listen to your opinions.<br>
     The algorithm noticed you <b>used enough</b> acknowledgement phrases (e.g. <q>I understand</q> or <q>I get</q>).<br>
     <b>Keep using these phrases</b> next time!</p>''',
     'imp': '''<p>Actively acknowledging that other opinions are valid, even if you do not agree with them, signals that you listen. This in turn encourages others to listen to your opinions.<br>
    ...
    {'fancy_name': 'Negation words',
     'imp': '''<p>Phrasing your arguments in positive terms helps avoid appearing argumentative - even if your opinions contradtict. This increases the chances of a more open response in return.<br>
     ...
     'recog': '''<p>Phrasing your arguments in positive terms helps avoid appearing argumentative - even if your opinions contradtict. This increases the chances of a more open response in return.<br>
    ...
    {'fancy_name': 'Hedging words',
     'recog': '''<p>Hedging your claims signals that you are open to other points of views. In return, others will be more open to yours.<br>
     The algorithm noticed you <b>used enough</b> hedging words (e.g. <q>almost</q> or <q>maybe</q>).<br>
     <b>Keep using these words</b> next time!</p>''',
     'imp': '''<p>Hedging your claims signals that you are open to other points of views. In return, others will be more open to yours.<br>
    ...
    {'fancy_name': 'Words that limit a statement',
     'imp': '''<p>Words such as just and only can sound condescending when you explain your point of view. Suggesting that things are obvious makes people feel inferior.<br>
     The algorithm noticed you used <b>too many</b> adverb limiters (e.g. <q>just</q>, <q>only</q>). Try to <b>decrease this</b> next time!</p>''',
     'recog': '''<p>Words such as just and only can sound condescending when you explain your point of view. Suggesting that things are obvious makes people feel inferior.<br>
    ...
    {'fancy_name': 'Disagreement phrases',
     'imp': '''<p>Although you may not agree with someone, being less direct with how you express your disagreement helps to avoid confrontation.<br>
     ...
     'recog': '''<p>Although you may not agree with someone, being less direct with how you express your disagreement helps to avoid confrontation.<br>
    ...
    {'fancy_name': 'Negative emotion phrases',
     'imp': '''<p>Phrases that contain negative emotions make you seem inconsiderate to others' feelings and makes them less likely to want to engage with you.<br>
     ...
     'recog': '''<p>Phrases that contain negative emotions make you seem inconsiderate to others' feelings and makes them less likely to want to engage with you.<br>
